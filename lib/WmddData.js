...
export const WmddData = {
    header: {
        ...
        description: "Get a glimpse of the incredible experiences and knowledge awaiting you at WMDD program."
    },
    programInfo: [
        {
            field: "Duration",
            value: "2 years (4 terms)"
        },
        {
            field: "Credential",
    ...
    programDetails: {
        ...
        description: "Be prepared to work on several projects during the courses, both individually and in teams. Our courses are structured to help you develop a digital portfolio and build industry connections.",
        ...
        seeAllLink: "https://langara.ca/programs-and-courses/programs/web-and-mobile-app/program-curriculum.html",
