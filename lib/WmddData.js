...
export const WmddData = {
    header: {
        ...
        description: "Welcome to Langara’s Web and Mobile Design and Development post graduate diploma program at Langara college. We want to invite you to take a look at the program curriculum to learn more about the unique WMDD experience and give you a good idea of what our program is all about."
    },
    curriculum: [
        {   
        ...
        {
            description: "After completing the WMDD post graduate diploma, students from both designers and developers will possess the technical and communication skills necessary for jobs in freelance, small businesses, or corporate environments."
        }
    ],
    button: {
    ...
    developer_details: [
        ...
        },
        {
            ...
            description: "Developers will be introduced to databases, server side scripting throughout various terms. Students will work on different projects throughout the program that require database integration with server side scripting. Developers will also be introduced to cloud and security technologies, including how to set up your own server on AWS and host your projects.",
            arrow: yellow_arrow
        },
    ...
    designer_details: [
        ...
        },
        {
            number: twoDark,
            title: "UI & UX Design",
            description: "Designers will focus on mobile and web design, learning how to  work with the principles of UX design for different types of applications. These principles include  information architecture, user research, interaction design, usability testing, wireframes and mockups. Designers will also build functional and interactive prototypes, and evaluate them with different methods such as observations, interviews, questionnaires, and videos.",
            arrow: dark_arrow
        },
        {
            number: threeDark,
