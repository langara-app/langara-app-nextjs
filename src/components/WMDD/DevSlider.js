...
const DevSlider = () => {
  ...
  const developerDetails = developerInfo.map((detail, idx) => (
    <>
  ...
  return (
    <DevContainer>
      ...
      <Slider {...settings}>
        <SliderContainer>{developerDetails[0]}</SliderContainer>
        <SliderContainer>{developerDetails[1]}</SliderContainer>
        <SliderContainer>{developerDetails[2]}</SliderContainer>
      </Slider>
    </DevContainer>
  );
};
